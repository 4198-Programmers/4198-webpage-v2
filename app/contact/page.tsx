...
const ContactPage = () => {
    ...
    const members = [
        ...
        { name: 'Owen Stutelberg', role: 'Team Captain', email: 'owenstutelberg@gmail.com', image: '/contact/OwenStutelberg.png' },
        ...
        { name: 'Varian & Lucian', role: 'Outreach Lead', email: 'outreach@team4198.org', image: '/contact/Lucian.png' },
        { name: 'Marcus Bauer', role: 'Media Lead', email: 'media@team4198.org', image: '/contact/MarcusBauer.png' },
